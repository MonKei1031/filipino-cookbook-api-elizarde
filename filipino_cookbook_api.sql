...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2026 at 04:14 PM
...
(17, 'samgyup', 4, 4, 'saute chicken in a pan until golden brown. add onion, garlic, potato, and carrots. Add 1 cup of water then let it simmer for 10 minutes. Add coconut milk, salt, pepper, and a tablespoon of vinegar. Top with pineapple tidbits for final touch.'),
(19, 'donut', 4, 4, 'saute chicken in a pan until golden brown. add onion, garlic, potato, and carrots. Add 1 cup of water then let it simmer for 10 minutes. Add coconut milk, salt, pepper, and a tablespoon of vinegar. Top with pineapple tidbits for final touch.'),
(20, 'avocado', 4, 4, 'saute chicken in a pan until golden brown. add onion, garlic, potato, and carrots. Add 1 cup of water then let it simmer for 10 minutes. Add coconut milk, salt, pepper, and a tablespoon of vinegar. Top with pineapple tidbits for final touch.');
...
ALTER TABLE `foods`
  ...
  ADD UNIQUE KEY `food_name_UNIQUE` (`food_name`),
